    ...
    <div className="relative max-w-3xl mb-12">
      ...
      >
        ...
        <input
          ...
          className="w-full bg-gradient-to-r from-purple-900/30 to-blue-900/30 backdrop-blur-sm border-2 border-purple-500/50 hover:border-purple-500 focus:border-purple-500 text-white placeholder-zinc-400 rounded-2xl py-5 pl-14 pr-32 outline-none transition-all duration-300 text-lg"
        />
        ...
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-2">
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold px-6 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center gap-2"
          >
            {isSearching ? (
              <>
