    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-950 via-zinc-900 to-black">
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          <header className="mb-12 md:mb-16">
            <div className="flex items-center justify-between mb-8">
              ...
              <nav className="hidden md:flex gap-6 text-sm text-zinc-400" aria-label="Main navigation">
                ...
                <button onClick={() => router.push('/movies')} className="hover:text-white transition-colors">
                  Browse Movies
                </button>
              </nav>
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-purple-500/10 border border-purple-500/30 rounded-2xl p-8 md:p-12 backdrop-blur-sm text-center">
              <Film className="w-16 h-16 mx-auto mb-4 text-purple-400" />
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                Discover Thousands of Movies
              </h3>
              <p className="text-zinc-300 mb-6 max-w-2xl mx-auto">
                Browse our complete collection with advanced filters by genre, rating, release date, and more. Find your next favorite movie!
              </p>
              <button
                onClick={() => router.push('/movies')}
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-purple-500/50 transition-all transform hover:scale-105"
              >
                <Film size={20} />
                Browse All Movies
              </button>
